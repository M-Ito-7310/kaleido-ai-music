...
|---------|---------|--------|--------|------|
| [enhancement-013](enhancement-013-remove-download-sort-option.md) | ライブラリのソート「ダウンロード順」を削除 | Medium | 2025-10-28 | 不要なソートオプションを削除、UIをシンプルに |
...
### 2025-10-28
- enhancement-013: ライブラリのソート「ダウンロード順」を削除 作成
...
### 計画中の改善 (1件)
- `/start-enhancement 13` - ライブラリのソート「ダウンロード順」を削除

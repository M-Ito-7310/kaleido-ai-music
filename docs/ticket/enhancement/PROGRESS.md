...
|---------|---------|--------|--------|------|
| [enhancement-011](enhancement-011-remove-duplicate-search-empty-message.md) | 検索結果0件時の重複メッセージを削除 | Low | 2025-10-27 | 検索結果0件時に表示される2つの類似メッセージを1つに統一 |
...
計画中のチケットに着手する場合は、以下のコマンドを実行してください：

- `/start-enhancement 11` - 検索結果0件時の重複メッセージを削除

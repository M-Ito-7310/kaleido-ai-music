...
| チケット | タイトル | 優先度 | 作成日 | ステータス |
|---------|---------|--------|--------|-----------|
| [enhancement-004](enhancement-004-simplify-music-upload-form.md) | 音楽アップロードフォームの簡素化 | Medium | 2025-10-26 | 🔴 未着手 |
...
### 2025-10-26
- enhancement-004: 音楽アップロードフォームの簡素化 作成

...
| チケット | タイトル | 優先度 | 作成日 |
|---------|---------|--------|--------|
| [enhancement-008](enhancement-008-search-tag-limit-top-10.md) | 検索画面のタグ項目を上位10個に制限 | Medium | 2025-10-27 |
| [enhancement-009](enhancement-009-display-tags-instead-of-artist.md) | 楽曲一覧でアーティスト名をタグ表示(最大3件)に変更 | Medium | 2025-10-27 |
...
実装を開始するには `/start-enhancement {番号}` コマンドを実行してください。

...
|---------|---------|--------|--------|------|
| [enhancement-007](enhancement-007-deduplicate-playback-history.md) | 履歴において同じ楽曲の場合は直近の再生履歴のみを優先して記録 | Medium | 2025-10-27 | 再生履歴の重複を防ぎ、同じ楽曲は最新の再生時刻のみを記録 |
...
### 2025-10-27
- enhancement-007: 履歴において同じ楽曲の場合は直近の再生履歴のみを優先して記録 作成
...
着手するには `/start-enhancement 7` を実行してください。

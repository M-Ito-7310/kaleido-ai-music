...
### 単体テスト
- [x] URL形式のバリデーションが正しく動作する
- [x] 空の値（null/undefined）が許可される
- [x] 不正なURL形式が拒否される

### 統合テスト
- [x] 共有リンク付きでアップロードできる
- [x] 共有リンクなしでアップロードできる
- [x] 保存された共有リンクが正しく取得できる

### E2Eテスト
- [x] アップロードフォームから共有リンクを入力して保存できる
- [x] 楽曲詳細ページで共有リンクが表示される
- [x] 共有リンクをクリックすると外部サイトに遷移する
...
実績時間: 30分
見積時間: 30-45分
Git commit: 586df9ee9684107ce1ca8a321e54bc29a0722ec2

...
| チケット | タイトル | ステータス | 作成日 |
|---------|---------|----------|--------|
| [bug-009](bug-009-tag-filter-search-not-working.md) | タグフィルター検索で対象音楽が表示されない | 🟡 進行中 | 2025-10-27 |
...
- bug-009: タグフィルター検索で対象音楽が表示されない (作成 📋)
...
- `/start-bug 9` - タグフィルター検索で対象音楽が表示されない（High優先度）

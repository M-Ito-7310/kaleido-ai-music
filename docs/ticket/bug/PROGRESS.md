...
| チケット | タイトル | ステータス | 作成日 |
|---------|---------|----------|--------|
| bug-008 | ダウンロード時のファイル名が正しく設定されない | 🟡 進行中 | 2025-10-27 |
...
1. **bug-008**: ダウンロード時のファイル名が正しく設定されない（Medium）
   - ダウンロード機能のファイル名生成ロジックを修正
   - 音楽メタデータ（タイトル、アーティスト名）を使用したファイル名に変更

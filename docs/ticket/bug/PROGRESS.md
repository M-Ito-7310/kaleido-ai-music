...
| チケット | タイトル | ステータス | 作成日 |
|---------|---------|----------|--------|
| [bug-016](bug-016-uploaded-songs-not-displayed.md) | 新規アップロード楽曲がダッシュボード・ライブラリに反映されない | 🔴 未着手 | 2025-10-30 |
...
- bug-016: 新規アップロード楽曲がダッシュボード・ライブラリに反映されない (作成 🆕)
...
#### bug-016: 新規アップロード楽曲がダッシュボード・ライブラリに反映されない (High)
- 音楽管理ページでは表示されるがダッシュボード/ライブラリで表示されない
- データ取得ロジックまたはキャッシュの問題の可能性
- `/start-bug 16` で修正を開始

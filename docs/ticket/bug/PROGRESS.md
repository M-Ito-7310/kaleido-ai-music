...
| チケット | タイトル | ステータス | 作成日 |
|---------|---------|----------|--------|
| [bug-015](bug-015-player-seekbar-not-working.md) | 音楽プレイヤーのシークバー移動が動作しない | 🟡 進行中 | 2025-10-29 |
...
- bug-015: 音楽プレイヤーのシークバー移動が動作しない (作成 📝)
...
#### Bug #015: 音楽プレイヤーのシークバー移動が動作しない (High)
- ミニプレイヤーのシークバーが動作しない問題
- 詳細ページのシークバーは正常動作
- `/start-bug 15` で修正開始

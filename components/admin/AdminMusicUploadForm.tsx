...
interface AdminMusicUploadFormProps {
  categories: Category[];
}

export function AdminMusicUploadForm({ categories }: AdminMusicUploadFormProps) {
  ...
  // ファイルアップロード関数（管理者専用APIエンドポイント使用）
